...
START TRANSACTION;
USE `enginexdb`;
INSERT INTO `job_post` (`id`, `job_requirements`, `start_date`, `completion_date`, `developers_needed`, `job_active`, `date_posted`, `date_closed`, `job_type_id`, `job_status_id`, `user_id`) VALUES (1, 'Full Stack Developer', '2021-11-04', '2021-11-30', 1, 1, '2021-10-29', NULL, 7, 2, 3);
INSERT INTO `job_post` (`id`, `job_requirements`, `start_date`, `completion_date`, `developers_needed`, `job_active`, `date_posted`, `date_closed`, `job_type_id`, `job_status_id`, `user_id`) VALUES (2, 'C#', '2021-11-04', '2021-11-28', 1, 1, '2021-10-27', NULL, 9, 2, 2);
...
INSERT INTO `job_post` (`id`, `job_requirements`, `start_date`, `completion_date`, `developers_needed`, `job_active`, `date_posted`, `date_closed`, `job_type_id`, `job_status_id`, `user_id`) VALUES (4, 'UI/UX', '2021-11-04', '2021-11-19', 1, 1, '2021-10-12', NULL, 5, 2, 1);
...
INSERT INTO `job_post` (`id`, `job_requirements`, `start_date`, `completion_date`, `developers_needed`, `job_active`, `date_posted`, `date_closed`, `job_type_id`, `job_status_id`, `user_id`) VALUES (7, 'Spring REST', '2021-11-04', '2021-11-28', 1, 1, '2021-10-26', NULL, 2, 2, 1);
...
INSERT INTO `job_post` (`id`, `job_requirements`, `start_date`, `completion_date`, `developers_needed`, `job_active`, `date_posted`, `date_closed`, `job_type_id`, `job_status_id`, `user_id`) VALUES (11, 'Graphics Developer', '2021-11-04', '2021-11-30', 4, 1, '2021-10-13', NULL, 18, 2, 1);
...
INSERT INTO `job_post` (`id`, `job_requirements`, `start_date`, `completion_date`, `developers_needed`, `job_active`, `date_posted`, `date_closed`, `job_type_id`, `job_status_id`, `user_id`) VALUES (16, 'SQL', '2021-11-04', '2021-11-17', 3, 1, '2021-10-23', NULL, 13, 2, 2);
...
START TRANSACTION;
USE `enginexdb`;
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (1, 0, 'Pending', '2021-11-01', 1, '2021-11-30', 3);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (2, 0, 'Pending', '2021-11-02', 2, '2021-11-28', 2);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (3, 0, 'Pending', '2021-11-03', 3, '2021-11-09', 3);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (4, 0, 'Pending', '2021-11-03', 4, '2021-11-19', 1);
