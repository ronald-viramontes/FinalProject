...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `enabled` TINYINT NOT NULL COMMENT '							',
...
CREATE TABLE IF NOT EXISTS `job_application` (
  ...
  `application_status` VARCHAR(45) NULL DEFAULT 'Pending Review',
...
START TRANSACTION;
USE `enginexdb`;
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (1, 'rodfed', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'ADMIN', 'Ronald', 'Viramontes', 'ron@example.com', '286-925-7463', 'https://robohash.org/doloribusutquas.jpg?size=300x400&set=set1', 1);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (2, 'jacob', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Jacob', 'Tweedy', 'tweedy@example.com', '997-653-6462', 'https://robohash.org/temporaundevoluptatem.jpg?size=300x400&set=set1', 2);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (3, 'garrett', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Garrett', 'Pipes', 'pipes@example.com', '506-692-6113', 'https://robohash.org/dolorinsit.jpg?size=300x400&set=set1', 3);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (4, 'fperez', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Fae', 'Pezey', 'fpezey3@va.gov', '242-208-3615', 'https://robohash.org/adipisciatempore.jpg?size=300x400&set=set1', 4);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (5, 'beckem', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Bartholomew', 'Ceccoli', 'bceccoli4@tamu.edu', '154-898-5216', 'https://robohash.org/nesciuntetipsa.jpg?size=300x400&set=set1', 5);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (6, 'dolton', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Dana', 'Lewin', 'dlewin5@foxnews.com', '100-376-6062', 'https://robohash.org/enimexqui.jpg?size=300x400&set=set1', 6);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (7, 'packer', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Colet', 'Whiff', 'cwhiff6@shutterfly.com', '971-858-0562', 'https://robohash.org/aliquidomnisdolorem.jpg?size=300x400&set=set1', 7);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (8, 'powerone', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Klement', 'Trude', 'ktrude7@cloudflare.com', '833-270-7719', 'https://robohash.org/debitisdoloribussit.jpg?size=300x400&set=set1', 8);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (9, 'happyone', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Hazlett', 'Japp', 'hjapp8@npr.org', '140-770-1673', 'https://robohash.org/vitaevoluptatemoptio.jpg?size=300x400&set=set1', 9);
...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (11, 'twinkle', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Callida', 'Bowling', 'cbowlinga@usa.gov', '963-961-1064', 'https://robohash.org/doloribusdebitisdolor.jpg?size=300x400&set=set1', 11);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (12, 'sapper', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Suzie', 'Ambrogiotti', 'sambrogiottib@smh.com.au', '959-407-2035', 'https://robohash.org/eaqueatodio.jpg?size=300x400&set=set1', 12);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (13, 'quantum', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Myrtle', 'Bayman', 'mbaymanc@umn.edu', '342-220-8148', 'https://robohash.org/illoprovidentnihil.jpg?size=300x400&set=set1', 13);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (14, 'intrepid', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Faulkner', 'Rignold', 'frignoldd@usnews.com', '619-397-7049', 'https://robohash.org/dignissimosanimiveniam.jpg?size=300x400&set=set1', 14);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (15, 'tomstone', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'April', 'Ibbitson', 'aibbitsone@cmu.edu', '961-118-0451', 'https://robohash.org/voluptasconsequaturvoluptate.jpg?size=300x400&set=set1', 15);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (16, 'antapol', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Auguste', 'Runnacles', 'arunnaclesf@icq.com', '295-915-8815', 'https://robohash.org/suntrerumlibero.jpg?size=300x400&set=set1', 16);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (17, 'caper', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Trueman', 'Brabbs', 'tbrabbsg@home.pl', '256-952-7102', 'https://robohash.org/atquerationeenim.jpg?size=300x400&set=set1', 17);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (18, 'alpha', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Nadiya', 'Kilgour', 'nkilgourh@nih.gov', '367-263-9039', 'https://robohash.org/estexcepturiut.jpg?size=300x400&set=set1', 18);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (19, 'gandoff', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Grazia', 'Danielis', 'gdanielisi@cnbc.com', '125-742-7125', 'https://robohash.org/corporisquiut.jpg?size=300x400&set=set1', 19);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `phone_number`, `image_url`, `company_id`) VALUES (20, 'omabe', '$2a$10$.bAtAkAx6AIbgO6UImrZYeQTaQSvt5tT5MYdaWyx6hpGNpSoSruim', 1, 'USER', 'Ollie', 'Mabe', 'omabej@google.com', '436-237-2536', 'https://robohash.org/ipsacumdignissimos.jpg?size=300x400&set=set1', 20);
...
START TRANSACTION;
USE `enginexdb`;
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (1, NULL, 'Pending Review', '2021-11-01', 1, '2021-11-30', 1);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (2, NULL, 'Pending Review', '2021-11-02', 2, '2021-11-28', 1);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (3, NULL, 'Pending Review', '2021-11-03', 3, '2021-11-09', 1);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (4, NULL, 'Pending Review', '2021-11-03', 4, '2021-11-19', 3);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (5, NULL, 'Pending Review', '2021-11-04', 5, '2021-11-21', 3);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (6, NULL, 'Pending Review', '2021-11-01', 6, '2021-11-30', 1);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (7, NULL, 'Pending Review', '2021-11-02', 7, '2021-11-28', 1);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (8, NULL, 'Pending Review', '2021-11-03', 8, '2021-11-09', 2);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (9, NULL, 'Pending Review', '2021-11-03', 9, '2021-11-10', 2);
INSERT INTO `job_application` (`id`, `application_approval`, `application_status`, `application_date`, `job_post_id`, `decision_date`, `user_id`) VALUES (10, NULL, 'Pending Review', '2021-11-04', 10, '2021-11-11', 3);
